...
class hpaif(Dataset):
    ...
    acc_list = ['672_E2*']#list of accepted paths == wildcard handling for wget
    urls = ['https://if.proteinatlas.org/672/']#parent directory(s)
    ...
    def __init__(self, root, train=False, transform=None, label_type = 'onehot', buffer_images=True, download=False):
